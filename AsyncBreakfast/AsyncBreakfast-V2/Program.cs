...
{
    /* The code on the main thread doesn't get blocked by the mehtod calls.
     * Hypothetically other code could be run in parallel, but there is
     * nothing in this example that would do that.
     * 
     * The async methods are all awaited so it takes just as long to make
     * breakfast in this version as in the starter version.
     */
